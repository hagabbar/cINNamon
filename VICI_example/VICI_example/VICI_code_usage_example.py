...
def get_params():
    params = dict(
        ...
        n_samples = 5, # number of posterior samples to save per reconstruction upon inference 
        ...
        report_interval=50000, # interval at which to save objective function values and optionally print info during inference training
        ...
        report_interval_fw=50000, # interval at which to save objective function values and optionally print info during multifidelity forward model training
...
#    - y_data_train_h = Accurate mesurements corresponding to x_data_train_h (noise-free waveforms)
#    - y_data_train_lh = Inaccurate mesurements corresponding to x_data_train_h (noisy waveforms)
#
...
#    - y_data_train_l = Inaccurate mesurements corresponding to x_data_train (noisy waveforms)
#
...
x_data_train_h, y_data_train_h, y_data_train_lh, y_data_test_h = make_samples.get_sets()
x_data_train, y_data_train_l = x_data_train_h, y_data_train_lh
params=get_params()
